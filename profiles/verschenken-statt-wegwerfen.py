...
download_url = 'https://www.berlin.de/umwelt/themen/abfall/verschenken-statt-wegwerfen/index.php/index/all.json?q='
# What to write for the changeset's source tag
source = 'Berliner Umweltportal / Verschenken statt Wegwerfen'
...
# TODO: PROBLEM, wir haben keine gute Overpass-Abfrage um die Locations zu bekommen, die wir suchen.
